...
export const projects: Project[] = [
  {
    ...
    problem: "后期动画、CG、剧情与改字补声频发，纯关键词检索难以定位可复用素材。",
    method: "索引历史音频、配音文本、角色与声学特征，支持语义、片段与相似声线三路检索。",
    value: "补录前先行完成复用判定，降低重复录制、棚期占用与紧急后期成本。",
    startDate: "2026.05",
  ...
  },
  {
    ...
    problem: "多棚多批次出档易出现漏收、归属混淆与重复追档。",
    method: "交叉比对配音文本、排班表与原始出档目录，输出完成率统计与待追清单。",
    value: "将出档状态转为可复查清单，降低漏判、误判与人工对账成本。",
    startDate: "2026.04",
  ...
  },
  {
    ...
    problem: "棚交付音频常存在命名不规范、缺失、格式或内容不符。",
    method: "依配音表与命名规则生成目标名，结合 ASR 标记高风险项，人工三栏复核。",
    value: "入库前拦截交付风险，减少后续重命名、返工与工程排查成本。",
    startDate: "2026.05",
  ...
  },
  {
    ...
    problem: "批量语音进入 Reaper 后，分轨、命名、对齐、Region 与导表反复手工处理。",
    method: "以 Lua 脚本完成轨道归类、Region 命名、对白对齐、响度统计与交付导表。",
    value: "将后期标准化与交付检查前移至工程内，减少导出后返查。",
    startDate: "2026.06",
