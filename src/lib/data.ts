...
export const projects: Project[] = [
  {
    ...
    problem: "版本后期常有动画、CG、剧情、改字和补声需求，纯关键词难以定位可用素材。",
    method: "索引历史音频、配音文本、角色与声学特征，按语义、片段和相似声音返回候选。",
    value: "在补录前完成复用判断，减少重复录制、棚期占用和紧急后期成本。",
    startDate: "2026.05",
  ...
  },
  {
    ...
    name: "AudioCheck",
    slug: "audio-check",
    positioning: "多棚出档回收检查",
    stageLabel: "出档回收",
    status: "Stable",
    progress: "2026.04 起 · 规则收口 · 稳定复用",
    problem: "多棚多批次出档容易出现漏收、归属混淆和重复追档。",
    method: "比对配音文本、排班表和原始出档目录，生成进度统计与待追清单。",
    value: "把出档状态转成可复查清单，降低漏判、误判和人工对账成本。",
    startDate: "2026.04",
  ...
  },
  {
    ...
    problem: "棚交付音频可能存在命名、缺失、格式或内容疑似不符。",
    method: "按配音表和命名规则生成目标名，并用 ASR 辅助识别高风险项。",
    value: "在入库前拦截交付风险，减少后续重命名、返工和工程排查成本。",
    startDate: "2026.05",
  ...
  },
  {
    ...
    problem: "批量语音进入 Reaper 后，分轨、命名、对齐、Region 和导表容易重复处理。",
    method: "用 Lua 脚本处理轨道归类、Region 命名、对白对齐、响度统计和交付导表。",
    value: "把后期标准化与交付检查前移到 Reaper 工程内，减少导出后返查。",
    startDate: "2026.06",
